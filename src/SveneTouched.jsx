        ...
        <div className="flex flex-col tracking-wider font-inter">
          ...
          <div className="flex flex-row justify-between border border-svene pl-40 pr-40 hover:bg-svene hover:text-black transition-colors duration-500 pt-5">
            ...
            <div className="flex justify-center items-center h-36">
              <p className="flex justify-end items-center h-36 text-right">
                Academic, Research, Technical, and I am yet to explore.<sup>1</sup> 
              </p>
            </div>
          </div>
          <div className="flex flex-row justify-between border border-svene pl-40 pr-40 hover:bg-svene hover:text-black transition-colors duration-500 pt-5">
          ...
          <div className="flex flex-row justify-between pl-40 pr-40 ">
            <div className="flex justify-end font-extralight text-sm items-center h-36 text-left w-4/12">
              <div className="flex-container">
                <p className="mt-10">
                  I am trying to learn how to write beyond the formal tone
                    and academic writing style that I have been dogmatically
                    adhering.<sup>1</sup> 
                </p>
                <p className="mt-5">
                This is a joke. The punchline is that I know “Programming Language.<sup>2</sup> 
                </p>
              </div>
            </div>
            <button className="sveneborder font-league tracking-widest text-3xl border mt-14 h-20 w-60  hover:bg-red-700 hover:border-red-700 hover:text-black  transition-colors duration-500" onClick={handleClick}>
              READ MORE
            </button>
          </div>
        </div>
